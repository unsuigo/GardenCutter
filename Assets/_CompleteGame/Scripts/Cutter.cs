...
namespace GardenCutter
{
    public class Cutter : MonoBehaviour
    {
        ...
        [SerializeField] [ColorUsage(true, true)] [Tooltip("The colour of the blade and trail")]
        ...
        //     _meshCutPlain = new Mesh();
        //     _meshParent.GetComponent<MeshFilter>().mesh = _meshCutPlain;
        //
        //     Material trailMaterial = Instantiate(_meshParent.GetComponent<MeshRenderer>().sharedMaterial);
        //     trailMaterial.SetColor("grin", _colour);
        ...
        //     bladeMaterial.SetColor("blue", _colour);
        ...
        //
        //     _meshCutPlain.vertices = _vertices;
        //     _meshCutPlain.triangles = _triangles;
        //
